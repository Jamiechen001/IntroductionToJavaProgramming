...
/**
 * 提示用户输入登记的身份以及可征税收入，计算并显示税款。
 * Created by JamieChen on 2017/1/26 0026.
 */
public class ComputeTax {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.println("1-单身纳税人");
        System.out.println("2-已婚共同纳税人或证实的鳏寡");
        System.out.println("3-已婚单独纳税人");
        System.out.println("4-家庭户主纳税人");
        ...
        System.out.print("个人收入税为： " + (int) (tax * 100) / 100.0);
    }
}
